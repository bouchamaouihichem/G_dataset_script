...
# You need a grid certificate to run this script, just google "grid certificate cms cern" to find out how to set it up then use the command 'voms-proxy-init -voms cms' and type your grid certificate password.

# Get all the GEN-SIM-RECO data sets, then GEN-SIM-DIGI-RAW data sets available
